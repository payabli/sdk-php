...
class GooglePayPaypointRegistrationData extends JsonSerializableType
{
    /**
     * @var ?string $entry
     */
    ...
    /**
     * @var ?GoogleWalletData $walletData
     */
    #[JsonProperty('walletData')]
    public ?GoogleWalletData $walletData;
