...
class QueryResponseNotificationsRecordsItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?DateTime $createdAt Timestamp of when notification was created, in UTC.
     */
    ...
    /**
     * @var ?DateTime $lastUpdated Timestamp of when notification was last updated, in UTC.
     */
