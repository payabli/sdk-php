...
class ApplicationDetailsRecord extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<ApplicationDetailsRecordMessagesItem> $messages
     */
    #[JsonProperty('messages'), ArrayType([ApplicationDetailsRecordMessagesItem::class])]
     ...
     *   mCity?: ?string,
     *   mCountry?: ?string,
     *   messages?: ?array<ApplicationDetailsRecordMessagesItem>,
     *   mState?: ?string,
     *   mZip?: ?string,
     *   orgId?: ?int,
