 ...
 */
class DeviceChallengeResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var DeviceChallengeData $responseData
     */
    #[JsonProperty('responseData')]
    public DeviceChallengeData $responseData;

    /**
     * @param array{
     *   responseText: string,
     *   responseData: DeviceChallengeData,
     *   responseCode?: ?int,
