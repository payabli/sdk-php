...
class PayabliApiResponseBills extends JsonSerializableType
{
    /**
     ...
     *    string
     *   |int
     * )|null $responseData If `isSuccess` = true, this contains the bill identifier. If `isSuccess` = false, this contains the reason for the error.
     */
